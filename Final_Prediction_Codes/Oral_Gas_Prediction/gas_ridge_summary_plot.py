...
# 설정
# ===================================================================
INPUT_DIR = "analysis_result_ridge_final_triangle" 
SUMMARY_FILE = "All_Models_Ridge_Summary.csv"
...
def plot_integrated_top3(input_dir, summary_file, output_filename):
    ...
    fig.suptitle("Top 3 Ridge Regression Models for Each Gas", fontsize=24, fontweight='bold', y=1.1)
